...
class ConfigProvider
{
    ...
    public function getConfig(): array
    {
        return [
            ...
            'cardSource' => $this->getCardSourceConfig(),
            'cardDestination' => $this->getCardDestinationConfig()
        ];
    }

    /**
     * @return array The card source config
     * @see self::@getConfig
     */
    public function getCardSourceConfig(): array
    {
        return [
            0 => [
                'width' => 50,
    ...
    /**
     * @return array The card destination config
     * @see self::@getConfig
     */
    public function getCardDestinationConfig(): array
    {
        return [
            0 => [
                'x' => 272,
